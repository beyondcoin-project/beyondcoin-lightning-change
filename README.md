...
[![build status](https://api.travis-ci.org/beyondcoin-project/beyondcoin-lightning-charge.svg)](https://travis-ci.org/beyondcoin-project/beyondcoin-lightning-charge)
<!--[![npm release](https://img.shields.io/npm/v/beyondcoin-lightning-charge.svg)](https://www.npmjs.com/package/beyondcoin-lightning-charge)-->
<!--[![docker release](https://img.shields.io/docker/pulls/beyondcoin-project/beyondcoin-lightning-charge.svg)](https://hub.docker.com/r/beyondcoin-project/beyondcoin-lightning-charge/)-->
[![MIT license](https://img.shields.io/github/license/beyondcoin-project/beyondcoin-lightning-charge.svg)](https://github.com/beyondcoin-project/beyondcoin-lightning-charge/blob/master/LICENSE)
[![Pull Requests Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](http://makeapullrequest.com)
<!--[![IRC](https://img.shields.io/badge/chat-on%20freenode-brightgreen.svg)](https://webchat.freenode.net/?channels=beyondcoin-lightning-charge)-->
...
```bash
$ npm install -g beyondcoin-project-lightning-charge
...
$ docker run -it -u `id -u` -v `pwd`/data:/data -p 9735:9735 -p 9112:9112 \
             ...
             beyondcoin-project/lightning-charge
```
...
```bash
$ docker run -it -e NETWORK=regtest -e API_TOKEN=mySecretToken -p 9112:9112 beyondcoin-project/beyondcoin-lightning-charge
```
...
To connect to a remote beyondcoind instance, set `BEYONDCOIND_URI=http://[user]:[pass]@[host]:[port]`
...
Clients libraries are available for [JavaScript](https://github.com/beyondcoin-project/lightning-charge-client-js)
and [PHP](https://github.com/beyondcoin-project/lightning-charge-client-php).
...
(see [`POST /invoice/:id/webhook`](https://github.com/beyondcoin-project/beyondcoin-lightning-charge#post-invoiceidwebhook)).
...
{"id":"KcoQHfHJSx3fVhp3b1Y3h","msatoshi":"10000","status":"unpaid","rhash":"6823e46a08f50...",
 "payreq":"lntbynd100n1pd99d02pp...","created_at":1515369962,"expires_at":1515373562}
...
$ cd beyondcoin-lightning-charge
$ npm install
$ npm test
```
